...
public class DeviceScanActivity extends ListActivity {
    private String BLEDeviceName="JJCRelayV1";
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(UploadStringActivity.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(UploadStringActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
